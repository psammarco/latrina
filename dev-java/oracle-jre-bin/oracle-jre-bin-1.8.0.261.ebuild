...
JRE_SRC="https://downloads.sourceforge.net/project/oracle-jre8-bin-gentoo/${P}-linux-x64.tar.gz -> jre-${JRE_PR}-linux-x64.tar.gz"
JCE_SRC="https://downloads.sourceforge.net/project/oracle-jre8-bin-gentoo/${JCE_FILE}"
